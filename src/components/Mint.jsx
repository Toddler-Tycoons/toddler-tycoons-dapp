        ...
        <div className="mint">
            ...
            <div className="content-wrapper">
                <div className="tycoon-imgs">
                    <img src={"./assets/imgs/tycoon3.png"} alt="Tycoon" className="tycoon3" />
                    <img src={"./assets/imgs/tycoon4.png"} alt="Tycoon" className="tycoon4" />
                </div>
                <div className="content">
                    <div className="title">Mint Tycoons</div>
                    <div className="mint-card">
                        <div className="input">
                            <input type="number" name="toMint" value={toMint} min={1} onChange={e => setToMint(e.target.value)} />
                            ...
                            {tokenIds?.map((tokenId, index) => {
                                return (
                                    <a
                                        key={index}
                                        target="_blank"
                                        href={"https://testnets.opensea.io/assets/mumbai/0x397567c3e75af2375a885e835bb519f71c22e86a/" + tokenId}
                                    >
                                        OpenSea
                                        <br />
                                    </a>
